    ...
    */
    ...
    AvastWRC.bal = {
        ...
        updateSp291Settings: function () {
            ...
            console.log("newSettingsNotifications");
            console.log(newSettingsNotifications);
        ...
        getLandingPageURL: function () {
            ...
            return { url: `https://www.${brandingSpecifics.brandingType}.com${brandingSpecifics.contain}`,
        ...
        AvastWRC.bal.sp = _.extend(AvastWRC.bal.SP || {}, {
            ...
            panelData: {
                ...
                images: AvastWRC.bal.utils.getLocalImageURLs({}, {
                    ...
                    redirectPlaceholder: "deals.png",
                    redirectPlaceholderBig: "Vertical-Deals-Repeat.gif",
            ...
            appiedCouponData: {
                ...
                strings: AvastWRC.bal.utils.loadLocalizedStrings({},["sasCouponAppliedOnPage","spNotificationRedirectShowMoreMessage","save"])                
            },
            ...
            getProviderInfo: function(data) {
                ...
                var queryOptions = {
                    ...
                    callback: function(domainInfoResponse) {
                        ...
                        var createPanelData = data;
                        createPanelData.panelData = AvastWRC.bal.sp.panelData;
                        createPanelData.panelData.minimizedPosition = AvastWRC.bal.settings.get().userSPPoppupSettings.notifications.minimized || {};
                        createPanelData.panelData.standardPosition = AvastWRC.bal.settings.get().userSPPoppupSettings.notifications.standard || {};
                        createPanelData.panelData.panelPosition = AvastWRC.bal.settings.get().userSPPoppupSettings.notifications.panel || {};
            ...
            siteNameIsContainedOnCurrentURL: function (url, urlToBeContained) {
                ...
                if(urlDomain.indexOf(urlToBeContainedDomain.split(".")[0]) != -1 ){
                    console.log("couponinTab: merchant (" + urlToBeContained + ") contained in url (" + url + ")");
                    return true;
                } else if(urlToBeContainedDomain.indexOf(urlDomain.split(".")[0]) != -1 ){
                    console.log("couponinTab: url (" + url + ") contained in merchant (" + urlToBeContained + ")");
                    return true;
                }else 
                    return false;
            },
            ...
            onPageComplete: function(tabId, tab, url) {
                ...
                if(couponInTabsToRemove && couponInTabsToRemove.coupon && couponInTabsToRemove.coupon.coupon_code && !couponInTabsToRemove.timer){
                    console.log("couponTab page complete removed " + JSON.stringify(couponInTabsToRemove));
                    var _tab = tab;
                    couponInTabsToRemove.timer = true;
                    setTimeout(() => {
                        AvastWRC.bs.tabExistsWithUrl(_tab.id, function (exist) {
            ...
            getAppliedCouponData: function(tab, eventDetails){
            ...
            safeShopFeedback: function(data, tab) {
                ...
                switch (data.type) {
                    ...
                    case "coupon_click":
                        ...
                        if(eventDetails.offer.type == 3){
                            console.log("this is a similar coupon -> only open the tab");
                            AvastWRC.bs.openInNewTab(data.url);
                        }
                        else if(eventDetails.offer.coupon_code){
                            console.log("this is a coupon with code-> open and close the tab");
                            ...
                            console.log("this is a coupon without code-> open and show the coupon in the newly opened tab");
                            AvastWRC.bs.openInNewTab(data.url, function(newTab) {
                                var couponInTabInfo =  AvastWRC.bal.sp.getAppliedCouponData(newTab, eventDetails)
                                AvastWRC.UtilsCache.set("coupons_tabs_to_show", newTab.id, couponInTabInfo);
                            });

                            if(AvastWRC.Utils.getBrowserInfo().isFirefox()){
                                AvastWRC.bs.getActiveTab(function(activeTab) {
                                    var couponInTabInfo =  AvastWRC.bal.sp.getAppliedCouponData(activeTab, eventDetails)
                                    AvastWRC.UtilsCache.set("coupons_tabs_to_show", activeTab.id, couponInTabInfo);
                                });
                            }
                        }
                        ...
                        switch (data.action) {
                            ...
                            case "shown":
                                ...
                                if (eventDetails.category === "COUPONS"){
                                    setTimeout(() => {
                                        AvastWRC.NotificationsManager.disableCouponsForDomain(AvastWRC.bal.getDomainFromUrl(tab.url));
                                    }, 2000);                                    
                                }
                                (AvastWRC.Burger != undefined)? AvastWRC.Burger.emitEvent("burger.newEvent", eventDetails):console.log("no burger lib");
                                break;
                    ...
                    case "settings_page":
                        switch (data.action) {
                            ...
                            case "settings_shown":
                                ...
                                break;
                            case "close_settings":
                                if(!AvastWRC.Utils.getBrowserInfo().isOpera()){
...
(function (AvastWRC, _) {
    AvastWRC.NotificationsManager = {
        ...
        notificationCommonData(notificationType, data){
            ...
            data.data.standardAB = this.standardABNotificationsAreEnabled();
            data.data.isPanelNotification = this.panelNotificationsAreEnabled();
            return data;
        },
        ...
        notifyCoupons: function (tab, data) {
            ...
            const notificationType = this.getNotificationType(this.config.messages.injected.showCouponsNotification, message);
            let messageData = {
                message: message,
                data: {
                    message: message,
        ...
        notifyOffers: function (tab, data) {
            ...
            const notificationType = this.getNotificationType(this.config.messages.injected.showOffersNotification, message);
            let messageData = {
                message: message,
                data: {
                    message: message,
        ...
        notifyCouponsAndOffers: function (tab, data) {
            ...
            const notificationType = this.getNotificationType(this.config.messages.injected.showOffersAndCouponsNotification, message);
            let messageData = {
                message: message,
                data: {
                    message: message,
        ...
        notifySimilarCoupons: function (tab, data) {
            ...
            const notificationType = this.getNotificationType(this.config.messages.injected.showSimilarCouponsNotification, message);
            let messageData = {
                message: message,
                data: {
                    message: message,
        ...
        notifyLoading: function (tab, data) {
            ...
            if(message == this.config.messages.injected.showLoadingNotification.minimized)return;
            const notificationType = this.getNotificationType(this.config.messages.injected.showLoadingNotification, message);
            let messageData = {
                message: message,
                data: {
                    message: message,
        ...
        notifyCityHotels: function (tab, data) {
            ...
            const notificationType = this.getNotificationType(this.config.messages.injected.showCityHotelsNotification, message);
            let messageData = {
                message: message,
                data: {
                    message: message,
        ...
        notifySimilarHotels: function (tab, data) {
            ...
            const notificationType = this.getNotificationType(this.config.messages.injected.showSimilarHotelsNotification, message);
            let messageData = {
                message: message,
                data: {
                    message: message,
        ...
        notifyRedirect: function (tab, data) {
            ...
            const notificationType = this.getNotificationType(this.config.messages.injected.showRedirectNotification, message);
            let messageData = {
                message: message,
        ...
        cancelLoading: function (tab, data) {
            if (this.config.onlyInMemoryValues.loadingActive[data.urlDomain]) {
                ...
                AvastWRC.NotificationsManager.blinkIcon(tab, data);
        ...
        getTemplateData: function () {
            return {
                ...
                standardAB: this.standardABNotificationsAreEnabled() || false,
        ...
        standardABNotificationsAreEnabled: function () {
            return AvastWRC.Shepherd.getNotificationsConfig().notificationType.standardAB;
        },
        panelNotificationsAreEnabled: function () {
        ...
        getNotificationMessage: function (messageKey) {
            if (this.notificationsAreMinimized()) {
                return messageKey.minimized;
            } else if (this.standardABNotificationsAreEnabled()) {
                return messageKey.standard;
            }else if (this.panelNotificationsAreEnabled()) {
                return messageKey.standard;
        ...
        getNotificationType: function (element, message) {
            return element.standard === message ? this.config.notificationType.standard : element.bar === message ? this.config.notificationType.bar : this.config.notificationType.minimized;
        },
        resolvers: {
            coupons: {
            ...
            couponsAreAvailable: function (data) {
                ...
                var result = AvastWRC.NotificationsManager.isCategoryAvailableForDomain(data.urlDomain, categoryFlag)  
                    && AvastWRC.NotificationsManager.resolvers.isCoupons(data) && ((AvastWRC.bal.settings.get().userSPPoppupSettings.notifications.coupons.showAlways)
            ...
            isSimilarCoupon: function (data) {
                ...
                var result = AvastWRC.NotificationsManager.isCategoryAvailableForDomain(data.urlDomain, categoryFlagForSimilarCoupons) 
                    && (data && data.similarCouponsValue)
                    && ((AvastWRC.bal.settings.get().userSPPoppupSettings.notifications.coupons.showAlways)
                        || !(AvastWRC.bal.settings.get().userSPPoppupSettings.notifications.coupons.hide || AvastWRC.NotificationsManager.couponHaveBeenShowedInDomain(data)));
                console.log("isSimilarCoupon", result);                
                return result; 
            },
            ...
            isLoading: function (data) {
                ...
                var result = AvastWRC.NotificationsManager.isCategoryAvailableForDomain(data.urlDomain, categoryFlag) 
                    && AvastWRC.NotificationsManager.resolvers.isCouponsOrSimilarCoupons(data) && !data.onlyFirstRequest;
            ...
            cancelLoading: function(data){
                var result = AvastWRC.NotificationsManager.config.onlyInMemoryValues.loadingActive[data.urlDomain];
                console.log("cancelLoading", result);
                return result;
            },
            blinkIcon : function(data){
                var result =  AvastWRC.NotificationsManager.resolvers.isProductsOrAccommodations(data);
                console.log("blinkIcon", result);
                return result;
            },
            ...
            isCouponsOrSimilarCoupons: function (data) {
                return data && (data.couponsLength || data.similarCouponsValue);
            },
        ...
        config: {
            messages: {
                ...
                injected: {
                    showOffersNotification: {
                        ...
                        standardAB: "showOffersNotification",
                    ...
                    showCouponsNotification: {
                        ...
                        standardAB: "showCouponsNotification",
                    ...
                    showOffersAndCouponsNotification: {
                        ...
                        standardAB: "showOffersAndCouponsNotification",
                    ...
                    showSimilarCouponsNotification: {
                        ...
                        standardAB: "showSimilarCouponsNotification",
                    ...
                    showCityHotelsNotification: {
                        ...
                        standardAB: "showCityHotelsNotification",
                    ...
                    showSimilarHotelsNotification: {
                        ...
                        standardAB: "showSimilarHotelsNotification",
            ...
            template: {
                strings: [
                    ...
                    "spBetterSpecialDealsNotificationBarMessage","spCouponsNotificationSaveTextMessage",
                ...
                images: {
                    ...
                    specialDealsPanel: "Vertical-Deals.gif",
                ...
                animations: {
                    ...
                    specialDealsPanel: "Vertical-Deals-Repeat.gif",
