...
(function($, EventEmitter) {
  ...
  AvastWRC.ial = AvastWRC.ial || {
    ...
    addRippleEffect: function (e, buttonClassName, bgColor) {
      ...
      if(!bgColor){
        if(AvastWRC.ial.sp.data.avastBranding){
          bgColor = "#087E3A";
        }
        else{
          bgColor = "#44cc88";
...
(function ($) {
    ...
    AvastWRC.ial.sp = {
        ...
        MinPanel: function (e, minimizedNotification) {
            ...
            AvastWRC.ial.sp.isPanelShown = false;
        ...
        MaxPanel: function (e) {
            ...
            AvastWRC.ial.sp.isPanelShown = true;
        ...
        notifications: {
            ...
            showRedirectNotification: function (data, template, notificationsType) {
                if(!AvastWRC.ial.sp.couponInTab) {
                    if ($('#a-sp-notifications-redirect').length <= 0) {
            ...
            loadNotification: function (notificationsType, data) {
                let buttonsWithRippleEffect = [".a-sp-notifications-button", ".a-sp-notifications-button-cover-click", ".a-sp-notifications-redirect-button-show", ".asp-notifications-bar-button"];
                ...
                if(AvastWRC.ial.sp.data.isPanelNotification && notificationsType !== AvastWRC.ial.sp.notifications.config.notificationsType.minimized){
                    if(AvastWRC.ial.sp.notifications.config.values.currentData.message !== "showLoadingNotification"){
                        console.log("message: ", AvastWRC.ial.sp.notifications.config.values.currentData.message)
                        AvastWRC.ial.sp.showPanelNotification(AvastWRC.ial.sp.notifications.config.values.currentData.message);
                    }                        
                    return;
                }
                ...
                function initRedirectBarNotification() {
                    if (AvastWRC.ial.sp.data.panelShown) return;
                ...
                function initStandardNotification() {
                    ...
                    function showNotification() {
                        ...
                        if(AvastWRC.ial.sp.data.panelData.notifications.templateData.standardAB){
                            if(currentData.replaceAB && currentData.replaceAB.length > 0){
                                let dataForRibbon = {
                                    standardAB: AvastWRC.ial.sp.data.panelData.notifications.templateData.standardAB,
                                    ribbonImage: AvastWRC.ial.sp.data.panelData.notifications.templateData.images.ribbon,
                                    ribbonText: currentData.replaceAB[0],
                                    ribbonMessage: currentData.replaceAB[1] ? 
                                            AvastWRC.ial.sp.data.panelData.notifications.templateData.strings.spCouponsNotificationSaveTextMessage :
                                            AvastWRC.ial.sp.data.panelData.notifications.templateData.strings.spBetterOfferLowerPricesNotificationMessage,
                                    ribbonStars: currentData.replaceAB[2],
                                    showRibbonStars: currentData.replaceAB[2] ? true : false
                                };
                                AvastWRC.ial.sp.UpdateContent(currentNotificationConfig.container, false, "a-sp-notification-ribbon", AvastWRC.Templates.ribbon, null, dataForRibbon);
                            }
                        ...
                        function addSimilarCouponsUrl() {
                            ...
                            if(AvastWRC.ial.sp.data.panelData.notifications.templateData.standardAB){
                                $(".a-sp-notifications-cover-click").attr("resurl", currentData.replace[1]);
                                $(".a-sp-notifications-button-cover-click").attr("resurl", currentData.replace[1]);
                            }
                        }
                    ...
                    function registerStandardEvents() {
                        let closeNotificationIcon = ".a-sp-notifications-header-close-icon",
                            ...
                            notificationCover = ".a-sp-notifications-cover-click",
                            notificationButtonCover = ".a-sp-notifications-button-cover-click",
                        ...
                        $(notificationButtonCover).click((e) => {
                            hideElement(AvastWRC.ial.sp.notifications.config.notificationsContainer.standard);
                        ...
                        $(notificationButtonCover).hover((e) => {
                            $(notificationsButton).addClass("a-sp-notifications-button-hover");                            
                        }, (e) => {
                            $(notificationsButton).removeClass("a-sp-notifications-button-hover"); 
                        },);
                ...
                function initMinimizedNotification() {
                    if (AvastWRC.ial.sp.isPanelShown) return;
                ...
                messages: {
                    injected: {
                        showOffersNotification: {
                            ...
                            replace: ["#similarCouponsButtonStandard .a-sp-notifications-button-show-amount"]
                        },
                        ...
                        showCityHotelsNotification: {
                            ...
                            replace: [".a-sp-city-hotels-notification-text-city", "#similarCouponsButtonStandard .a-sp-notifications-button-show-amount"],
                        },
